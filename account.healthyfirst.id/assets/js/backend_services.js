...
(function(exports) {
	...
	var itemsHelper = new ItemsHelper(); 
	var usageHelper = new UsageHelper();
	var bookingHelper = new BookingHelper();
    ...
    exports.initialize =  function(bindEventHandlers) {
		...
		$('#filter-items .results').jScrollPane();
		$('#filter-usage .results').jScrollPane();
    ...
    function _bindEventHandlers() {
        ...
        $('.tab').click(function() {
            ...
            } else if ($(this).hasClass('items-tab')) { // display categories tab
                $('#items').show();
                helper = itemsHelper;
            } else if ($(this).hasClass('usage-tab')) { // display categories tab
                $('#usage').show();
                helper = usageHelper;
            } else if ($(this).hasClass('booking-tab')) { // display categories tab
                $('#booking').show();
		...
		itemsHelper.bindEventHandlers();
		usageHelper.bindEventHandlers();
		bookingHelper.bindEventHandlers();
    }
