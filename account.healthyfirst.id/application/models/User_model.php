...
class User_Model extends CI_Model {
    ...
    public function check_login($username, $password) {
        ...
        $user_data = $this->db
                ->select('ea_users.id AS user_id, ea_users.email AS user_email,'
                        . 'ea_roles.slug AS role_slug, ea_user_settings.username, ea_users.first_name AS first_name, ea_users.last_name AS last_name')
                ->from('ea_users')
    ...
    public function forgotpassword($email) {
		...
		$this->email->from('noreply@healthyfirst.id', 'No-Reply HealthyFirst.id');
		$this->email->to($email);

		$this->email->subject('Forgot Password');
		$this->email->message($message)->set_mailtype('html');		
