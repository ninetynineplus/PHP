...
class Appointments extends CI_Controller {
	...
	public function getList()
	{
		...
		$pages = 0;
        $list = $this->appointments_model->getAll($pages);		
		
		$view = array(
			'status' => $this->appointments_model->status,
			'model' => $list,
			'pages' => $pages
		);

		$this->load->view('appointments/list', $view);
	}
	...
	public function getform()
	{
		...
		$view = array(
			'model' => $this->appointments_model,
			'services' => $this->services_model,
			'providers' => $this->providers_model,
			'id' => $id
		);		

		$this->load->view('appointments/edit', $view);
	}	
}
